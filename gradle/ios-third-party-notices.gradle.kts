...
fun buildIosThirdPartyNotices(): String {
    ...
    return buildString {
        append("THIRD-PARTY NOTICES - Loupe on iOS: the on-device Loupe Decision Model (ONNX Runtime + tokenizers)\n")
        ...
        append("Copyright line applies. The model weights (Laya by Convai, the base of the Loupe Decision\n")
        append("Model) have their own notice in the app; the Kotlin libraries are covered by the app's\n")

...
data class JudgmentReport(
    ...
    fun summary(): String = buildString {
        append("$judgmentId: ")
        append("selective ${formatFixed(selectiveAccuracy * 100, 1)}% at ${formatFixed(coverage * 100, 0)}% coverage")
        append(", ECE ${formatFixed(ece, 3)}")
        append(", baseline ${formatFixed(baselineAccuracy * 100, 1)}%")
